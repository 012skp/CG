...
# if you are using linux you can directly use 'a' executable file.
# to make 'a' executalbe command is:
$ chmod +x a



# 'a.cc' is the filename, compile it using c++11 or above version.
$ g++ -std=c++11 -o a a.cc
# this creates a executable file 'a'



# 'a' is the executable file which needs to pass command line argument 'test'.
# 'test' is a file containing input for program.
$ ./a test
...
# each of n successive objects is represented as follows.
